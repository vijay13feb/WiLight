...
# These match batchprocessing.py: Tc = 1/167 s per Doppler frame, window = 360 frames.
_DOPPLER_FRAME_RATE_HZ: float = 167.0   # STFT Doppler frames per second
...
def parse_args():
    ...
    search_group.add_argument('--retrain_epochs', type=int, default=10,
